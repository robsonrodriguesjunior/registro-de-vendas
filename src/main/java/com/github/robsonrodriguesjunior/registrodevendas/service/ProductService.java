...
/**
 * Service Implementation for managing {@link com.github.robsonrodriguesjunior.registrodevendas.domain.Product}.
 */
@Service
@Transactional
public class ProductService {
    ...
    /**
     *  Get all the products where TopSellingProductsView is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<Product> findAllWhereTopSellingProductsViewIsNull() {
        log.debug("Request to get all products where TopSellingProductsView is null");
