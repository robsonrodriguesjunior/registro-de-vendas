...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().code(DEFAULT_CODE).name(DEFAULT_NAME);
        // Add required entity
        Category category;
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().code(UPDATED_CODE).name(UPDATED_NAME);
        // Add required entity
        Category category;
        if (TestUtil.findAll(em, Category.class).isEmpty()) {
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.code(UPDATED_CODE).name(UPDATED_NAME);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.code(UPDATED_CODE).name(UPDATED_NAME);
